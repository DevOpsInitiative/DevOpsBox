...
mkdir /opt/sag-ci
chown jenkins /opt/sag-ci
su - jenkins -c "cd /opt/sag-ci && git clone https://github.com/SoftwareAG/sagdevops-ci-assets"

echo "****** Jenkins Initial Admin Pwd: "`sudo cat /var/lib/jenkins/secrets/initialAdminPassword`" ******"
echo "****** SAG_CI_HOME:               /opt/sag-ci                      ******"
